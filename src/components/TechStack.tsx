...
import {
  SiNextdotjs, SiLangchain,SiTailwindcss, SiTypescript, SiMongodb, SiMysql,SiOpenai,SiVercel,SiGithub,SiPostgresql,SiExpress,SiRedux,SiDocker,SiFirebase,SiLinux,SiBun,SiFramer
} from "react-icons/si";
...
const techIcons = [
  ...
  // Extra 🔥 based on your stack
  { icon: <SiOpenai className="text-green-400" />, name: "OpenAI", gradient: "from-green-300 to-emerald-500" },
